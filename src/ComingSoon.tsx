...
const ComingSoon: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-[#fe0000] to-[#fcc611] flex items-center justify-center p-3 md:p-5 relative overflow-hidden">
      <div 
      ...
      <div className="relative backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-6 md:p-10 text-center shadow-2xl max-w-4xl w-full animate-fade-in">
        ...
        <div className="mb-8">
          ...
          {/* <div className="text-xl md:text-2xl font-bold text-[#fcc611] mb-8">Shop at JP Fashion</div> */}
        </div>

        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">Shop at JP Fashion</h3>
          <div className="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-4 items-start">
            {images.map((img, idx) => (
              ...
              >
                <img src={img} alt={`Model ${idx + 1}`} className="w-full h-48 md:h-64 object-cover object-top" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-8">
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">Contact Us</h3>
          <div className="flex flex-row justify-center items-center gap-4">
            <a href="tel:0112772154" className="backdrop-blur-md bg-white/20 hover:bg-white/30 border border-white/30 text-white p-3 rounded-full flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
              </svg>
            </a>
            <a href="https://wa.me/94711660660" target="_blank" rel="noopener noreferrer" className="backdrop-blur-md bg-green-600/80 hover:bg-green-600 border border-white/20 text-white p-3 rounded-full flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg">
            ...
            <a href="https://web.facebook.com/jptextilesl" target="_blank" rel="noopener noreferrer" className="backdrop-blur-md bg-blue-600/80 hover:bg-blue-600 border border-white/20 text-white p-3 rounded-full flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="https://www.tiktok.com/@jpfashion._?lang=en-GB" target="_blank" rel="noopener noreferrer" className="backdrop-blur-md bg-black/80 hover:bg-black border border-white/20 text-white p-3 rounded-full flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
